...
Function, integrate this based on the Kirkwood-Buff equation for closed systems,
and print out the value in various points along the lenght of the integral.
